...
class Room:
    """Parses a tile-map string into platforms, hazards, enemies, exits, and skill unlock tiles for one level room."""
    ...
    def draw(self, screen, camera):
        ...
        # Draw win tile: gold with white border
        for rect in self.win_tiles:
            screen_rect = camera.apply(rect)
            pygame.draw.rect(screen, (255, 215, 0), screen_rect)
            pygame.draw.rect(screen, (255, 255, 255), screen_rect, 3)
